package java; /*************************************************************************
 *  Compilation:  javac java.AnimatedHanoi.java
 *  Execution:    java java.AnimatedHanoi N
...
public class AnimatedHanoi {
    ...
    public static void main(String[] args) {
        int N;
        if (args.length == 0) N = 4;                           // default
        else                  N = Integer.parseInt(args[0]);   // number of discs
